...
export default function OtpVerify({ onClose }) {
  ...
  useEffect(() => {
    ...
    if (allFilled && status !== "error") {
      setButtonText("ادامه");
    } else if (!allFilled && status !== "error") {
      setButtonText("ادامه");
    }
  }, [otp, status]);
        ...
        {showOtpModal && (
          <div
            className={`fixed inset-0 z-50 flex items-end justify-center transition-all duration-300 ${
              showOverlay ? "bg-black/30 backdrop-blur-[2px]" : "bg-transparent"
            }`}
            ...
            >
              ...
              <form onSubmit={handleSubmit}>
                ...
                <p className="text-[13px] text-[#040E1A80] mb-6">
                  ارسال دوباره کد:{" "}
                  <span className="font-semibold">3:00 دقیقه</span>
                </p>
